    ...
    <svg viewBox="0 0 60 260" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <linearGradient id="liquidFill" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="hsl(158,28%,36%)" stopOpacity="0.5" />
          <stop offset="100%" stopColor="hsl(158,28%,30%)" stopOpacity="0.7" />
        </linearGradient>
      </defs>
  ...
  return (
    <div>
      ...
      <input
        ...
        style={{
          background: `linear-gradient(to right, hsl(158,28%,36%) 0%, hsl(158,28%,36%) ${percent}%, hsl(160,15%,20%) ${percent}%, hsl(160,15%,20%) 100%)`,
        }}
